...
- UI list/create/view/update/delete interactions are slices that own their local HTTP contracts.
...
- `src/symphony-test-1.Web` and `tests/ui` for implemented WASM behavior and component coverage.
